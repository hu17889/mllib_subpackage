...
@Since("1.2.0")
@Experimental
case class LambdaBoostingStrategy @Since("1.4.0") (
    // Required boosting parameters
    @Since("1.2.0") @BeanProperty var treeStrategy: LambdaStrategy,
    ...
    treeStrategy.algo match {
      ...
      case _ =>
        throw new IllegalArgumentException(
          s"LambdaBoostingStrategy given invalid algo parameter: ${treeStrategy.algo}." +
...
object LambdaBoostingStrategy {
   ...
   */
  @Since("1.2.0")
  def defaultParams(algo: String): LambdaBoostingStrategy = {
